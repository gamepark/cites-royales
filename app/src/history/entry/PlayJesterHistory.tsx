...
export type PlayJesterRuleHistoryProps = {} & MoveComponentProps

export const PlayJesterHistory: FC<PlayJesterRuleHistoryProps> = (props) => {
  ...
  return (
    <Trans i18nKey={isMe ? 'history.jester.you' : 'history.jester.player'}
